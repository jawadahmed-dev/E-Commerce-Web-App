...
export class ShopService {
  ...
  getProducts(productParams : ProductParams)
  {
    ...
    return this.http.get<IResponse<IPagination<IProduct>>>(this.baseUrl + 'products', {params : params});
  }
  getProductTypes()
  {
    return this.http.get<IResponse<IProductType[]>>(this.baseUrl + 'products/types');
  }
  getProductBrands()
  {
    return this.http.get<IResponse<IProductBrand[]>>(this.baseUrl + 'products/brands');
  }
